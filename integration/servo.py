...
assign_folder2 = Frame(id_=0, dlc=8, data=[ck.servo_id, 2, 0, 2, 0, 0, 2, 0x3])

# Assign envelope 0x201 to folder 3
# Servo current transmit
assign_folder3 = Frame(id_=0, dlc=8, data=[ck.servo_id, 2, 1, 2, 0, 0, 3, 0x3])

# Assign envelope 0x202 to folder 4
# Battery voltage transmit
assign_folder4 = Frame(id_=0, dlc=8, data=[ck.servo_id, 2, 2, 2, 0, 0, 4, 0x3])

# Assign envelope 0x203 to folder 5
# Servo voltage transmit
assign_folder5 = Frame(id_=0, dlc=8, data=[ck.servo_id, 2, 3, 2, 0, 0, 5, 0x3])

# Assign envelope 0x204 to folder 6
# H-bridge current transmit
assign_folder6 = Frame(id_=0, dlc=8, data=[ck.servo_id, 2, 4, 2, 0, 0, 6, 0x3])

# Assign envelope 0x205 to folder 7
# Set servo voltage receive
assign_folder7 = Frame(id_=0, dlc=8, data=[ck.servo_id, 2, 5, 2, 0, 0, 7, 0x3])

# Assign envelope 0x206 to folder 8
# PWM frequency config receive
assign_folder8 = Frame(id_=0, dlc=8, data=[ck.servo_id, 2, 6, 2, 0, 0, 8, 0x3])
