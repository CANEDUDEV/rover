...
#define REG_VOUT_MEASURE_PIN GPIO_PIN_7
#define REG_VOUT_MEASURE_GPIO_PORT GPIOA
#define VBAT_U_MEASURE_PIN GPIO_PIN_4
#define VBAT_U_MEASURE_GPIO_PORT GPIOC
#define VBAT_I_MEASURE_PIN GPIO_PIN_5
#define VBAT_I_MEASURE_GPIO_PORT GPIOC
#define REG_POWER_ON_PIN GPIO_PIN_2
#define REG_POWER_ON_GPIO_PORT GPIOD
