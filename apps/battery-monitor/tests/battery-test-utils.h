...
DECLARE_FAKE_VOID_FUNC(set_reg_vout_power_on)
DECLARE_FAKE_VOID_FUNC(set_reg_vout_power_off)
...
DECLARE_FAKE_VALUE_FUNC(power_state_t, get_reg_vout_power_state)
