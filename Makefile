##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.19.2] date: [Thu Mar 09 13:54:16 CET 2023] 
##########################################################################################################################
...
CFLAGS += -std=c17 -pedantic-errors $(MCU) $(C_DEFS) $(C_INCLUDES) $(OPT) -Wall -Werror -fdata-sections -ffunction-sections
...
#######################################
# link script
LDSCRIPT = STM32F302RETx_FLASH.ld
